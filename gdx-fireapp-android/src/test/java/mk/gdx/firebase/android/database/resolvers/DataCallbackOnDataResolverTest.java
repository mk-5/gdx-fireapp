...
public class DataCallbackOnDataResolverTest extends AndroidContextTest {
    ...
    public void resolve() {
        ...
        // When
        DataCallbackOnDataResolver.resolve(String.class, Mockito.mock(OrderByClause.class), Mockito.mock(DataSnapshot.class), dataCallback);
    ...
    public void resolve2() {
        ...
        // When
        DataCallbackOnDataResolver.resolve(String.class, Mockito.mock(OrderByClause.class), dataSnapshot, dataCallback);

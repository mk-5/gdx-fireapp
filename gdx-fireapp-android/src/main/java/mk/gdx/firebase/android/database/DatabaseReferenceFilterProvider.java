 ...
 */
public class DatabaseReferenceFilterProvider implements FilterProvider<DatabaseReference, Query>
{
     ...
     */
    @Override
    public <V> Query apply(FilterType filterType, DatabaseReference target, V[] filterArguments)
    {

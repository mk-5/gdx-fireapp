...
class FuturePromiseGroovyTest extends Specification {
    ...
    void setup() {
        FuturePromise.setAutoSubscribe(false)
    }
...
//        def someResult = "abc"
//        def arrResult = []
//        def futurePromise = FuturePromise.when({ args ->
//            arrResult.push(1)
//            (args[0] as FuturePromise).doComplete(someResult);
//        })
...
//    }
    ...
    def "should call do 'after flow'"() {
        ...
        when:
        promise.then(consumer).subscribe()

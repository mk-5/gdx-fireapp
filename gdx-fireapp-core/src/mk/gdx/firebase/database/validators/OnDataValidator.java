...
/**
 * Validates arguments for {@link DatabaseDistribution#onDataChange(Class, DataChangeListener)}
 */
public class OnDataValidator implements ArgumentsValidator {

    private static final String MESSAGE1 = "Database#onDataChange needs at least 2 arguments";
    private static final String MESSAGE2 = "The first argument should be class type";
    private static final String MESSAGE3 = "The second argument should be null or DataChangeListener";

...
class BiConsumerWrapper implements BiConsumer<String, Throwable> {
    ...
    private final Array<BiConsumer<String, ? super Throwable>> consumers = new Array<>();

    @Override
    public void accept(String s, Throwable t) {
        for (BiConsumer<String, ? super Throwable> consumer : consumers) {
            consumer.accept(s, t);
        }
        consumers.clear();
    }

    void addConsumer(BiConsumer<String, ? super Throwable> consumer) {

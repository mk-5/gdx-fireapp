 ...
 */
public class GdxFIRAppleAuth extends PlatformDistributor<AppleAuthDistribution> implements AppleAuthDistribution {
    ...
    protected String getIOSClassName() {
        return "pl.mk5.gdx.fireapp.ios.auth.AppleAuth";
    }
    ...
    protected String getAndroidClassName() {
        return "pl.mk5.gdx.fireapp.android.auth.AppleAuth";
    }
    ...
    protected String getWebGLClassName() {
        return "pl.mk5.gdx.fireapp.html.auth.AppleAuth";
    }
}

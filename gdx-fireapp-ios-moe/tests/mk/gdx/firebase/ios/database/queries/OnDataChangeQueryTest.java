...
public class OnDataChangeQueryTest extends GdxIOSAppTest {
    ...
    public static void afterClass() {
        Whitebox.setInternalState(OnDataChangeQuery.class, "observersManager", new DataObserversManager());
    }
    ...
    public void run() throws Exception {
        ...
        Whitebox.setInternalState(OnDataChangeQuery.class, "observersManager", dataObserversManager);

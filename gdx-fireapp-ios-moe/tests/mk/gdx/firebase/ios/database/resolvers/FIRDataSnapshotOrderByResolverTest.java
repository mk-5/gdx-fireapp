...
public class FIRDataSnapshotOrderByResolverTest extends GdxIOSAppTest {
    ...
    public void shouldResolveOrderBy() {
        ...
        // When
        boolean shouldResolve = FIRDataSnapshotOrderByResolver.shouldResolveOrderBy(orderByClause, dataType, firDataSnapshot);

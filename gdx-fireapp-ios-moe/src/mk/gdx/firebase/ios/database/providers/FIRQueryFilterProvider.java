 ...
 */
public class FIRQueryFilterProvider implements FilterProvider<FIRDatabaseQuery, FIRDatabaseQuery>
{
    ...
    @Override
    public <V> FIRDatabaseQuery apply(FilterType filterType, FIRDatabaseQuery target, V[] filterArguments)
    {
        switch (filterType) {
            case LIMIT_FIRST:

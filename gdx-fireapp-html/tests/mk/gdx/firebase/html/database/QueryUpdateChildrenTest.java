...
public class QueryUpdateChildrenTest {
    ...
    public void runJS() {
        ...
        // When
        ((QueryUpdateChildren) query.withArgs(Mockito.mock(Map.class))).execute();
    ...
    public void runJS2() {
        ...
        // When
        ((QueryUpdateChildren) query.withArgs(Mockito.mock(Map.class)).with(Mockito.mock(FuturePromise.class))).execute();

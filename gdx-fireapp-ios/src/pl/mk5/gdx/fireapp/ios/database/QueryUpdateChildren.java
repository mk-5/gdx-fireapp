...
class QueryUpdateChildren extends DatabaseQuery<Void> {
    ...
    protected Void run() {
        ((FIRDatabaseReference) query).updateChildValues(NSDictionaryHelper.toNSDictionary(arguments.get(0)), new FIRDatabaseReferenceCompleteObserver((FuturePromise) promise));
        return null;
    }
}
